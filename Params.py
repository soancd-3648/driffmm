...
def ParseArgs():
	...
	parser.add_argument('--conditional_diffusion', type=bool, default=True, help='whether to use conditional diffusion denoiser')
	parser.add_argument('--cond_dim', type=int, default=64, help='hidden size for condition projection in denoiser')
	parser.add_argument('--cond_dropout', type=float, default=0.1, help='dropout on condition vectors')
